...
- [x] Expand guide proposal handling beyond the current scripted log-set/end-session prompts. Guide proposals now support update assessment, advance session flow, log set, and end session as closed action types; guided target intake saves targets directly.
